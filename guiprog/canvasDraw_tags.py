...
class CanvasEventDemo(canvasDraw.CanvasEventsDemo):
    ...
    def create_oval_tagged(self,x1,y1,x2,y2):
        objId=self.canvas.create_oval(x1,y1x2,y2)
        slef.canvas.itemconfig(objId,tag='rectangles',fill='red')
        return objId

    def create_rectangle_tagged(self,x1,y1,x2,y2):
        objId=self.canvas.create_rectangle(x1,y1,x2,y2)
        self.canvas.itemconfig(objId,tag='rectangles',fill='red')
        return objId
